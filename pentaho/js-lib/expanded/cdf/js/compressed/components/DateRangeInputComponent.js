...
return BaseComponent.extend({update:function(){function e(){s&&u&&(a.fireInputChange(a.startValue,a.endValue),
s=u=!1)}var t,a=this,n=this.name,r=this.getStartParamValue(),i=this.getEndParamValue(),o=this.inputSeparator=this.inputSeparator||">";
t=$(void 0==this.singleInput||1==this.singleInput?'<input class="date-range-single-input" id="'+n+'" value="'+r+" "+o+" "+i+'"/>':'<input class="date-range-multiple-input" id="'+n+'" value="'+r+'"/>'+o+'<input class="date-range-multiple-input-2" id="'+n+'2" value="'+i+'"/>'),
this.placeholder().addClass("date-range-input-container").html(t),a.on("onOpen:dateRangeInput",a.onOpenEvent),
a.on("onClose:dateRangeInput",a.onCloseEvent);var s,u,l=t.offset(),d=void 0!=a.earliestDate?a.earliestDate:Date.parse("-1years"),p=void 0!=a.latestDate?a.latestDate:Date.parse("+1years"),g=void 0!=a.leftOffset?a.leftOffset:0,h=void 0!=a.topOffset?a.topOffset:15,c=void 0==a.dateFormat||null==a.dateFormat?"yy-mm-dd":a.dateFormat;
$(function(){a.placeholder("input").daterangepicker({posX:l.left+g,posY:l.top+h,earliestDate:d,
latestDate:p,dateFormat:c,rangeSplitter:o,onOpen:function(){a.triggerOnOpen(),s=u=!1,
a.startValue=null,a.endValue=null,a.addCancelButton()},onDateSelect:function(t,n){
s=!0,a.storeChanges(t,n),e()},onClose:function(){a.triggerOnClose(),u=!0,e()}}),a._doAutoFocus(),
